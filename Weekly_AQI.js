...
var table = ee.FeatureCollection("projects/ee-monikamdr/assets/Dhulikhelt");
...
// Title bar
Map.add(ui.Label('Weekly Average AQ Monitor of Dhulikhel', {fontWeight: 'bold', fontSize: '28px'}));
...
// Density (Formaldehyde, Nitrogen, Sulfur)
var densVis2 = { 
  min: 0, 
  max: 0.0005, 
  palette: Inferno
